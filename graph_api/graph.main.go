...
import (
	...
	"github.com/sirawong/bookrental-microservices/graph_api/resolvers"
...
func main() {
	...
	svcs, err := services.NewClientGrpc(services.ServicesConfig{
		BooksSvc:   booksSvc,
	...
	graphAPIHandler := handler.NewDefaultServer(generated.NewExecutableSchema(generated.Config{Resolvers: resolvers.NewResolver(svcs)}))
